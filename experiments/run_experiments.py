...
from experiments import (compute_metrics_for_df, run_correlation_experiment,
                         run_knn_experiment)
...
def main():
    ...
    run_correlation_experiment(
        custom_metrics_with_knowledge,
        metrics,
        target_column="edit_time"
    )
    run_knn_experiment(
        custom_metrics_with_knowledge,
        metrics,
    ...
    run_correlation_experiment(
        custom_metrics_without_knowledge,
        metrics,
        target_column="edit_time"
    )
    run_knn_experiment(
    ...
    run_correlation_experiment(
        ...
        metrics,
        target_column="time",
        group_by_annotator=True
    )
    run_knn_experiment(
        iwslt_df,
        metrics,
        target_column="time",
        consolidate_annotators=True
    )
